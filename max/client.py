...
class Client(object):
    ...
    def set_private_create_order(self, pair, side, amount, price, stop='', _type='limit', client_id='', group_id=''):
        ...
        # Print the form data before sending the request
        # Print the form data before sending the request in a formatted JSON style
        formatted_form = json.dumps(form, indent=4)
        print("Sending order with the following form data:")
